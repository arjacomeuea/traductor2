...
class Traductor
{
    static Dictionary<string, string> diccionario = new Dictionary<string, string>()
    {
        ...
        {"week", "semana"}, {"case", "caso"}, {"point", "punto/tema"},
        {"government", "gobierno"}, {"company", "empresa/compañía"}
    };
    ...
    static void TraducirFrase()
    {
        ...
        {
            string palabraLimpiada = palabras[i].Trim(',', '.', ';', '!', '?');
            if (diccionario.ContainsKey(palabraLimpiada))
            {
                palabras[i] = diccionario[palabraLimpiada];
            }
        }
